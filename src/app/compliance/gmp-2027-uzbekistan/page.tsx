...
export const metadata: Metadata = {
  title:
    'Сертификат GMP в Узбекистане 2027: порядок и сроки получения',
  description:
  ...
  openGraph: {
    ...
    description:
      'Reference-hub для QA-департаментов фарм-предприятий Узбекистана: нормативная база, аудит-чек-листы, поэтапная подготовка к обязательной GMP-сертификации с 1 января 2027 г.',
...
const sectionNav: SectionNav[] = [
  ...
  { id: 'inspector-checks', label: 'Что проверяет инспектор' },
...
const prepStages: PrepStage[] = [
  {
    ...
    tasks: [
      'Independent gap-аудит по EU GMP + Annex 1 (2022) + узбекистанским регуляторным требованиям.',
      ...
      'Назначение QP с правом подписи и подача документов на верификацию в Агентство по развитию фармотрасли.',
    ],
  },
  {
  ...
  },
  {
    ...
    tasks: [
      'External mock inspection с GMP-экспертом за 4-6 недель до подачи заявки на GMP-инспекцию.',
      'Финальная сборка inspection-package: SMF, VMP, CCS, SOP-list, batch records, deviations, CAPA, PQR.',
      'Подача заявки на GMP-инспекцию (через портал uzpharm-gxp.uz Центра надлежащих практик или офис в Ташкенте).',
...
const relatedStandards: RelatedStandard[] = [
  {
    ...
    whyRelevant:
      'Инспектор Центра надлежащих практик при инспекции стерильных производств ориентируется именно на эту версию. Аудит ожидает CCS-документ, APS-данные, EM-программу, gowning-квалификацию по §4.',
  ...
  },
  {
    ...
    whyRelevant:
      'Обязательно для производителей API в Узбекистане (включая заводы полного цикла с собственным синтезом). Инспектор проверяет соответствие Q7 параллельно с Annex 1 в зонах финальной очистки.',
  },
  {
    shortName: 'ICH Q9 (R1)',
...
export default function ComplianceGmpUzbekistan2027Page() {
  ...
  const techArticleJsonLd = {
    ...
    description:
      'Reference-hub по обязательной GMP-сертификации фарм-предприятий Узбекистана к 1 января 2027 г.: нормативная база, перечень субъектов сертификации, аудит-чек-листы, поэтапная подготовка, связанные международные стандарты, типичные ошибки.',
    ...
    about: [
      ...
      { '@type': 'Thing', name: 'Агентство по развитию фармацевтической отрасли' },
      { '@type': 'Thing', name: 'Центр надлежащих практик (GMP-инспекции)' },
    ...
    <>
      ...
      <section className="bg-brand-dark py-12 px-4 lg:px-[80px]">
        ...
        <div className="max-w-[900px]">
          ...
          <p className="text-[16px] md:text-[18px] text-brand-muted mt-4 leading-relaxed">
            Что должны успеть фарм-предприятия, как готовится регулятор, какие
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="space-y-5 text-[15px] text-text leading-relaxed">
            <p>
              ...
              фармацевтической отрасли при Минздраве</strong> — портал{' '}
              <a
              ...
              . Агентство ведёт регистрацию фарм-предприятий и выдаёт регистрационные
              удостоверения, а GMP-инспекции непосредственно проводит ГУП «Центр
              надлежащих практик» (портал{' '}
              <a
                href="https://uzpharm-gxp.uz"
                target="_blank"
                rel="noopener noreferrer"
                className="text-brand underline inline-flex items-center gap-1"
              >
                uzpharm-gxp.uz <ExternalLink size={12} />
              </a>
              ) — он же оформляет GMP-сертификаты по итогам инспекции.
            </p>
            <p>
            ...
            <p>
              Регулятор ориентируется на <strong>EU GMP</strong> и{' '}
            ...
            <p>
              ...
              производителей — только узбекистанский сертификат от Центра надлежащих практик.
            </p>
            <p>
              ...
              тем же указом УП-137 для них установлен{' '}
              <Link
                href="/compliance/iso-13485-uzbekistan"
                className="text-brand font-semibold hover:underline"
              >
                сертификат по ISO 13485 с 1 июля 2027 года
              </Link>
              , на полгода позже фармацевтического срока. Иностранные
      ...
      >
        <div className="max-w-[1100px] mx-auto">
          ...
          <p className="text-[15px] text-text mb-8 max-w-[800px] leading-relaxed">
            GMP-инспекция Центра на площадке обычно занимает 3-5 рабочих дней.
      ...
      >
        <div className="max-w-[1100px] mx-auto">
          ...
          <p className="text-[15px] text-text mb-8 max-w-[800px] leading-relaxed">
            ...
            GMP-инспекции. Полный 24-месячный таймлайн с детализацией каждого
            квартала — в нашей{' '}
            <Link
      ...
      <section className="bg-brand-dark py-16 px-4 lg:px-[80px]">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <p className="text-[16px] text-brand-muted mb-8 leading-relaxed">
            ...
            партий, ISO 9001 / 13485, CE) — под inspection-package для GMP-инспекции.
