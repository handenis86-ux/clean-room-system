...
export const metadata: Metadata = {
  title:
    'GMP сертификация в Узбекистане 2027 — требования и подготовка для фарм-завода',
  description:
    'Полный гид по обязательной GMP-сертификации фарм-производств Узбекистана к 1 января 2027 г.: требования АРФО, нормативная база, ресурсы для подготовки, типичные ошибки.',
  alternates: {
