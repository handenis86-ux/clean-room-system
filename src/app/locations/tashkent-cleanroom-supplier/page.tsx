...
const audienceList: AudienceItem[] = [
  ...
  },
  {
    ...
    description:
      'Аналитические и микробиологические лаборатории фарм-предприятий — точка приложения биоиндикаторов Terragene Bionova (паровая, ЭО, плазма), reference standards-доступа, расходников для подготовки образцов. Опыт работы с компетентными GMP-аудиторами.',
  },
  {
        ...
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="space-y-5 text-[15px] text-text leading-relaxed max-w-[900px]">
            <p>
              ...
              Координатор — <strong>Агентство по развитию фармацевтической
              отрасли</strong> при Минздраве, GMP-инспекции непосредственно
              проводит <strong>ГУП «Центр надлежащих практик»</strong>.
              Обе организации расположены в Ташкенте. Это означает:
              ташкентские фарм-предприятия фактически находятся в зоне
              регулярного контакта с инспекторами и испытывают повышенное
              внимание регулятора по сравнению с предприятиями в регионах.
            </p>
            <p>
              <strong>Региональная специфика GMP-инспекций в Ташкенте.</strong>{' '}
              ...
              регион для гармонизации с EU GMP и PIC/S, и Центр надлежащих практик формирует
        ...
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="space-y-5 text-[15px] text-text leading-relaxed max-w-[900px]">
            ...
            <p>
              ...
              Опыт работы с локальной регуляторикой (Минздрав, Агентство по развитию фармотрасли, Центр надлежащих практик), понимание языка
      ...
      <section className="bg-brand-dark py-16 px-4 lg:px-[80px]">
        <div className="max-w-[850px] mx-auto text-center">
          ...
          <p className="text-[16px] text-brand-muted mb-8 leading-relaxed">
            ...
            compliance-документацией под inspection-package для GMP-инспекции.
          </p>
        ...
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-[12px] text-text-muted mt-1">
                Требования регулятора, чек-листы, ресурсы
              </p>
            </Link>
            <Link
