          ...
          <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-10 mt-10">
            ...
            <article className="prose-content max-w-3xl">
              ...
              <section id="scope" className="mb-12">
                ...
                <p className="mb-4">
                  Annex 1 §4.33 и USP &lt;1072&gt; рассматривают
                ...
                <p className="mb-4">
                  ...
                  недельным циклом по Annex 1 §4.33.
                </p>
                ...
                <p className="mb-4">
                  ...
                  необученного оператора. Согласно §7.3 Annex 1,
              ...
              <section id="rotation" className="mb-12">
                ...
                <p className="mb-4">
                  Annex 1 §4.33 требует включения
