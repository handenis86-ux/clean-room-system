 ...
 * Annex 1 (2022) не существует — ни официального, ни нашего. Собственный
 * перевод решено не делать: ждём новую редакцию документа, переводить
 * устаревающий текст нормативки смысла нет. Позиция оставлена в списке
 * как справка — специалисту полезно знать, что искать нечего.
 */
const EDITIONS: Edition[] = [
  ...
  },
  {
    id: 'uz',
    lang: 'UZ',
    label: 'Oʻzbekcha — не издавался',
    note: 'Официального узбекского перевода Annex 1 не существует. Ждём новую редакцию документа — переводить текст, который скоро обновится, преждевременно',
  },
];
        ...
        {unlocked ? (
          <div className="text-center py-4">
            ...
            <p className="text-[14px] text-text-muted leading-relaxed">
              Скачивайте нужные редакции слева. Если документ обновится —
              сообщим.
            </p>
          </div>
        ) : (
          <>
            ...
            <p className="text-[13px] text-text-muted leading-relaxed mb-4">
              Документ бесплатный. Контакты нужны, чтобы сообщить, когда выйдет
              новая редакция Annex 1.
            </p>
            <LeadMagnetForm
              compact={false}
              requirePhone
