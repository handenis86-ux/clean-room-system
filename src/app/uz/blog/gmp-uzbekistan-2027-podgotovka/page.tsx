...
<table>
  ...
  <tbody>
    ...
    <tr><td>2026 Q4 (Noy)</td><td>T-2</td><td>«Toʻgʻri amaliyot markazi»ga GMP-tekshiruv uchun ariza topshirish. Inspection-paketni yakuniy yigʻish: SMF, VMP, CCS, SOP roʻyxati, batch records, deviations log, CAPA, PQR.</td></tr>
...
<p>EU GMP dan farqli, «Toʻgʻri amaliyot markazi» inspektori qoʻshimcha oʻzbekiston regulyatori hujjatlarini ham tekshiradi. Konsultant-emigrantlarga tayanib «Yevropa namunasi boʻyicha» tayyorgarlik koʻrayotgan korxonalar buni koʻpincha hisobga olmaydi. Quyida — Markaz alohida nima soʻraydi.</p>
...
<ul>
  <li><strong>1. SOPlar faqat ingliz tilida.</strong> Korporativ shablon yoki konsultant-emigrant SOPlarni «Ona kompaniyada shunday» boʻlgani uchun ingliz versiyasida qoldiradi. «Toʻgʻri amaliyot markazi» inspektori oʻzbek yoki rus tilida oʻqiydi. Tasdiqlangan tarjimasiz — audit birinchi soatda bloklanadi.</li>
...
<p><strong>Tekshiruvni kim oʻtkazadi?</strong><br/>«Toʻgʻri amaliyot markazi» davlat unitar korxonasi inspektorlari (uzpharm-gxp.uz), baʼzi hollarda xorijiy konsultantlar jalb qilinishi bilan. PIC/Sga aʼzo boʻlgach, sxema mamlakatlari vakillari ham tekshiruvlarga jalb qilinishi mumkin.</p>
<p><strong>Boshqa mamlakatda berilgan GMP-sertifikati amal qiladimi?</strong><br/>PIC/S davlatining sertifikati eʼtirof etilishi mumkin, lekin mahalliy sharoitda muvofiqlikni tasdiqlash uchun «Toʻgʻri amaliyot markazi» GMP-tekshiruvidan ozod qilmaydi. Toʻliq validatsiya — 6-12 oy.</p>
