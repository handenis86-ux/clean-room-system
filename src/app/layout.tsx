...
export const metadata: Metadata = {
  ...
  description:
    'B2B поставщик расходных материалов и одежды для чистых помещений в Узбекистане: GMP, ISO 14644. Решения для фармацевтики, пищевой промышленности, косметики и микроэлектроники в Ташкенте.',
  keywords: [
