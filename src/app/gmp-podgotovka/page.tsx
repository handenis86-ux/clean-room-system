...
export const metadata: Metadata = {
  title:
    'Подготовка к GMP в Узбекистане 2027: обучение, аудит, сопровождение АРФО',
  description:
    'Поможем пройти инспекцию АРФО с первого раза. Обучение QA, подготовка SOP, mock inspection, supplier qualification. Партнёрство с практикующими GMP-консультантами. Бесплатная диагностика готовности.',
  alternates: {
  ...
  openGraph: {
    title:
      'Подготовка к GMP в Узбекистане 2027 — обучение, аудит, сопровождение АРФО',
    description:
      'Поможем пройти инспекцию АРФО с первого раза. Партнёрство с практикующими GMP-консультантами Pharma Park. Бесплатная диагностика готовности предприятия.',
    type: 'website',
...
const services: ServiceItem[] = [
  ...
  },
  {
    ...
    description:
      'Site Master File, Validation Master Plan, batch records, deviations log, CAPA. Адаптация шаблонов под узбекистанский язык и формат АРФО.',
  },
  {
    icon: Search,
  ...
  },
  {
    ...
    description:
      'Имитация инспекции АРФО за 2-3 месяца до реальной. 3-5 дней на площадке, plant-walk, опрос персонала, проверка inspection-package.',
  },
  {
    icon: Briefcase,
    title: 'Сопровождение на инспекции АРФО',
    description:
      'Присутствие на площадке во время инспекции, помощь с reply-letter, закрытие observations в течение 30 дней. Опыт прохождения реальных инспекций АРФО.',
  },
  {
    icon: Layers,
...
const whyUs: WhyItem[] = [
  {
    ...
    description:
      'Видим, что реально просят инспекторы АРФО на площадках. Знаем, какие compliance-документы поставщиков критично иметь готовыми к инспекции.',
  },
  {
    title: 'Партнёрство с практикующими GMP-консультантами',
    description:
      'Не теоретики — наши партнёры уже сертифицировали предприятия в Узбекистане и работают с резидентами Pharma Park. Опыт реальных инспекций АРФО.',
  },
  {
...
const processSteps: ProcessStep[] = [
  ...
  },
  {
    ...
    description:
      'Регулярные визиты, mock inspection за 2-3 мес. до подачи заявки, присутствие на инспекции АРФО, помощь с reply-letter. Контракт до получения сертификата.',
    duration: '12-24 мес.',
  },
];
...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      'Стоимость нашего сопровождения за 18 месяцев — диапазон $30-100k в зависимости от размера предприятия и стартового состояния. Это закрывает методологию: gap-аудит, SOP, обучение, mock inspection, сопровождение на инспекции АРФО. Отдельно идут расходы на инфраструктуру (HVAC, ремонт зон), QC-лабораторию и закупку расходников. Полная разбивка бюджета — на бесплатном 30-минутном созвоне.',
  },
  {
  ...
  {
    question: 'Можно ли получить сертификат GMP без аудита АРФО?',
    answer:
      'Нет. Для локального производителя в Узбекистане обязательна инспекция АРФО на площадке — это единственный путь получения узбекистанского сертификата GMP. Иностранные GMP-сертификаты (EU, FDA, MHRA) признаются только для импортёров при регистрации препарата, но не освобождают локальный завод от инспекции. Узбекистан движется к полному членству в PIC/S (горизонт 2027-2029), что в будущем расширит mutual recognition, но до этого момента — только инспекция АРФО.',
  },
  {
    question: 'В чём отличие от обычного консалтинга?',
    answer:
      'Три ключевых отличия. (1) Single window: получаете методологию консалтинга и compliance-пакет поставщика расходников в одной коммуникации — никаких отдельных тендеров. (2) Знание узбекистанской специфики: наши партнёры уже проходили инспекции АРФО, знают язык документации, региональные нюансы. (3) Точка обзора со стороны supplier: видим, какие compliance-документы критичны на инспекции «изнутри 13 действующих GMP-заводов», которые мы снабжаем — это даёт практический фильтр для приоритизации подготовки.',
  },
  {
    question: 'Что если инспекция АРФО найдёт нарушения?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Да. Для медицинских изделий это ISO 13485 + национальные требования (отдельный регуляторный путь, не АРФО, но методология подготовки сходна). Для БАД и косметики — упрощённые системы качества (HACCP, GMP косметики ISO 22716), для которых тот же подход «обучение + SOP + supplier qualification» применим. Объём сопровождения и стоимость значительно ниже, чем для фармы — обсуждаем индивидуально.',
  },
];
...
export default function GmpPodgotovkaPage() {
  const serviceJsonLd = {
    ...
    description:
      'Обучение QA-персонала, подготовка SOP и документации, pre-audit, mock inspection, сопровождение на инспекции АРФО, разработка CCS, supplier qualification расходников. Партнёрство с практикующими GMP-консультантами для фарм-предприятий Узбекистана.',
    provider: {
      '@type': 'Organization',
        ...
        <div className="max-w-[1100px] mx-auto">
          ...
          <h1 className="text-[28px] md:text-[42px] lg:text-[48px] font-extrabold text-white leading-[1.1] max-w-[900px]">
            ...
            <span className="text-brand-muted">
              обучение, аудит, сопровождение инспекции АРФО
            </span>
          </h1>
          ...
          <p className="text-[16px] md:text-[18px] text-brand-muted mt-5 leading-relaxed max-w-[800px]">
            ...
            пройти инспекцию АРФО с первого раза. Работаем в партнёрстве с
        ...
        <div className="max-w-[1100px] mx-auto">
          <div className="max-w-[800px] mb-10">
            ...
            <p className="text-[15px] md:text-[16px] text-text mt-4 leading-relaxed">
              7 направлений подготовки к инспекции АРФО — от обучения QA-команды
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-[12px] text-text-muted mt-1">
                Нормативная база АРФО, кого касается, чек-лист инспектора
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-[12px] text-text-muted mt-1">
                PDF-чек-лист готовности к инспекции АРФО
              </p>
            </Link>
          </div>
        </div>
